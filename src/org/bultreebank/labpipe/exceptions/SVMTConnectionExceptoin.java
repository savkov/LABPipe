 ...
 */
public class SVMTConnectionExceptoin extends Exception {

    /**
     * Creates a new instance of <code>SVMTConnectionExceptoin</code> without detail message.
     */
    public SVMTConnectionExceptoin() {
    }


    /**
     * Constructs an instance of <code>SVMTConnectionExceptoin</code> with the specified detail message.
     * @param msg the detail message.
     */
    public SVMTConnectionExceptoin(String msg) {
        super(msg);
    }
}
