...
public class EmptyConfigFileException extends Exception {
    ...
    /**
     * Creates a new instance of <code>EmptyConfigFileException</code> without detail message.
     */
    ...
    /**
     * Constructs an instance of <code>EmptyConfigFileException</code> with the specified detail message.
     * @param msg the detail message.
     */
    public EmptyConfigFileException(String msg) {
        super(msg);
    }
}