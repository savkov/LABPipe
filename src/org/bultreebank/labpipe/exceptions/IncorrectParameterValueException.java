...
public class IncorrectParameterValueException extends Exception {
    ...
    /**
     * Creates a new instance of <code>IncorrectParameterValueException</code> without detail message.
     */
    ...
    /**
     * Constructs an instance of <code>IncorrectParameterValueException</code> with the specified detail message.
     * @param msg the detail message.
     */
    public IncorrectParameterValueException(String msg) {
        super(msg);
    }
}
