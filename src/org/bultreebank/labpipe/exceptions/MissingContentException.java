...
public class MissingContentException extends Exception {
    ...
    /**
     * Creates a new instance of <code>MissingContentException</code> without detail message.
     */
    public MissingContentException() {
    }

    /**
     * Constructs an instance of <code>MissingContentException</code> with the specified detail message.
